...
TOKEN = '6255127710:AAHfB5lZeWVB4-fo3PRwjvr3xn30vnupDnc'
...
# Introduce a state variable to track the current menu level
MENU_MAIN = 0
MENU_SUBMENU_1 = 1
MENU_SUBMENU_2 = 2
MENU_SUBMENU_3 = 3
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Set the menu state to main menu
...
async def submenu_1(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Set the menu state to submenu 1
